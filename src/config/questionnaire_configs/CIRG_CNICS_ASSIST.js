...
export default {
  ...
  yLineFields: [
    { ...SUBSTANCE_USE_LINE_PROPS, key: "ASSIST-10", label: "Cocaine/crack", color: "#0072B2", shape: "ring" },
    { ...SUBSTANCE_USE_LINE_PROPS, key: "ASSIST-11", label: "Methamphetamine", color: "#D55E00", shape: "star" },
    { ...SUBSTANCE_USE_LINE_PROPS, key: "ASSIST-12", label: "Heroin", color: "#009E73", shape: "triangle" },
    { ...SUBSTANCE_USE_LINE_PROPS, key: "ASSIST-13", label: "Fentanyl", color: "#CC79A7", shape: "cross" },
    { ...SUBSTANCE_USE_LINE_PROPS, key: "ASSIST-14", label: "Narcotic pain meds", color: "#56B4E9", shape: "rectangle" },
    { ...SUBSTANCE_USE_LINE_PROPS, key: "ASSIST-15", label: "Sedatives", color: "#E69F00", shape: "square" },
    { ...SUBSTANCE_USE_LINE_PROPS, key: "ASSIST-16", label: "Marijuana", color: "#8884FF", shape: "diamond"},
    { ...SUBSTANCE_USE_LINE_PROPS, key: "ASSIST-17", label: "Stimulants", color: "#545E56", shape: "wye" },
    { ...SUBSTANCE_USE_LINE_PROPS, key: "ASSIST-18", label: "Inhalants", color: "#061658", shape: "asterisk" },
    { ...SUBSTANCE_USE_LINE_PROPS, key: "ASSIST-19", label: "Psychedelics", color: "#3DB6B1", shape: "circle"},
  ],
