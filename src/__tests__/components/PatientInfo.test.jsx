...
describe("Testing PatientIno component", () => {
  ...
  it("Render patient info - with patient object", () => {
    const patientObj = {
      name: [
        {
          use: "official",
  ...
  it("Render patient info - without name", () => {
    const patientObj = {
      name: [],
      telecom: [
        {
